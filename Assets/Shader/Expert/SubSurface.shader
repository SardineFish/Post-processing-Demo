Shader "MyShader/Expert/SubSurface"{
	Properties{
        ...
        _Fresnel ("Fresnel", Range(1, 64)) = 5
		_LOD ("LOD", Range(0, 8)) = 1
	...
	SubShader{
		...
		Pass {
			...
			fixed4 frag(v2f i):SV_TARGET{
                ...
                float3 reflection = texCUBElod(_CubeMap, float4(reflectDir, _LOD)).rgb;
                ...
                lightBack = lightBack * _LightColor0 * albedo;
				...
				float3 color = diffuseTerm * fresnel + specularTerm + lightBack;// specularTerm + diffuseTerm + ambient;
